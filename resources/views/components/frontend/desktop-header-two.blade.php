            ...
            <div class="container-fluid">
                <div class="header-wrap">
                    <div class="header-top-left">
                        <a href="tel:{{ $allsettings['call_us'] }}">
                            <p class="contact-info">
                                ...
                                {{ __('Gọi chúng tôi:') }}
                                {{ $allsettings['call_us'] }} {{ __('(Miễn phí)') }}
                            </p>
                        </a>
                    </div>
                    <div class="top-bar-menu">
                        <ul class="menu-list">
                            <li class="menu-item">
                                <a class="menu-link" href="{{ route('about.us') }}">Về chúng tôi</a>
                            </li>
                            <li class="menu-item">
                                <a class="menu-link" href="{{ route('blog') }}">Blog</a>
                            </li>
                            <li class="menu-item">
                                <a class="menu-link" href="{{ route('faq') }}">Cách mua hàng</a>
                            </li>
                            <li class="menu-item">
                            ...
                            <div class="container">
                                <ul class="mega-menu">
                                    <li class="mega-menu-item">
                                        <a class="mega-menu-title" href="#">{{ __('Danh mục') }}</a>
                                        <ul class="menu-items">
                                    ...
                                    <li class="mega-menu-item">
                                        <a class="mega-menu-title" href="#">{{ __('Thương hiệu') }}</a>
                                        <ul class="menu-items">
