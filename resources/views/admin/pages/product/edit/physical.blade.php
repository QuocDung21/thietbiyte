                        ...
                        <div class="tab-pane fade show active" id="nav-one" role="tabpanel"
                            ...
                            <form enctype="multipart/form-data" method="POST"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="en_about" id="en_about"
                                                          class="form-control">{!! $product->en_About !!}</textarea>
                                            </div>

                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Description') }}</label>
                                                <textarea name="en_description" id="summernote"
                                                          class="form-control">{!! $product->en_Description !!}</textarea>
                                            </div>

                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Shipping Return') }}</label>
                                                <textarea name="en_shippingreturn" id="summernote2"
                                                          class="form-control">{!! $product->en_ShippingReturn !!}</textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                                <label
                                                    for="exampleInputEmail1">{{ __('Additional Information') }}</label>
                                                <textarea name="en_additionalinformation" id="summernote3"
                                                          class="form-control">{!! $product->en_AdditionalInformation !!}</textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                            ...
                                            <div class="input__group mb-25">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" value="1"
                                                           ...
                                                           name="feature" class="custom-control-input"
                                                           id="customSwitch2">
                                                    <label class="custom-control-label"
                                    ...
                                    {{--                                                          class="form-control">{!! $product->fr_Description !!}</textarea>--}}
                                    {{--                                            </div>--}}
                                    {{--                                            <div class="input__group mb-25">--}}
                                    {{--                                                <label for="exampleInputEmail1">{{ __('ShippingReturn') }}</label>--}}
                                    {{--                                                <textarea name="fr_shippingreturn" id="summernote5"--}}
                                    {{--                                                          class="form-control">{!! $product->fr_ShippingReturn !!}</textarea>--}}
                                    {{--                                            </div>--}}
                                    {{--                                            <div class="input__group mb-25">--}}
                                    {{--                                                <label--}}
                                    {{--                                                    for="exampleInputEmail1">{{ __('AdditionalInformation') }}</label>--}}
                                    {{--                                                <textarea name="fr_additionalinformation" id="summernote6"--}}
                                    {{--                                                          class="form-control">{!! $product->fr_AdditionalInformation !!}</textarea>--}}
                                    {{--                                            </div>--}}
