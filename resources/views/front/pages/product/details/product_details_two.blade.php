                    ...
                    <div class="product-single-right">
                        ...
                        <div class="product-right-bottom">
                            <ul class="features">
                                <li class="single-feature">
                                    <img class="icon"
                                         ...
                                         alt="icon"/><strong
                                        class="feature-title">{{ __('Ước tính giao hàng trong:') }}</strong><span
                            ...
                            <div class="share-area d-flex align-items-center mt-30">
                                <h3 class="share-title">{{ __('Chia sẻ:') }}</h3>
