    ...
    <div class="breadcrumb-area">
        <div class="container">
            <div class="breadcrumb-wrap text-center">
                <h2 class="page-title">{{ __('Chỉnh sửa hồ sơ') }}</h2>
                <ul class="breadcrumb-pages">
                    <li class="page-item"><a class="page-item-link"
                                             href="{{ route('front') }}">{{ __('Trang chủ') }}</a></li>
                    <li class="page-item">{{ __('Chỉnh sửa hồ sơ') }}</li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill"
                                        ...
                                        {{ __('Thay đổi thông tin hồ sơ') }}</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    ...
                                    <div class="profile-form mt-5">
                                        <form enctype="multipart/form-data" action="{{ route('user.profile.update') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        <label for="date">{{ __('Ngày sinh') }}</label>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="form-group">
                                                        <label for="lname">{{ __('Địa chỉ') }}</label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label for="about-info">{{ __('Giới thiệu về bạn') }}</label>
                                                        <textarea class="form-control info-box" id="about-info"
                                                                  name="about" rows="3"
                                                                  placeholder="{{ __('Nói điều gì đó về bản thân bạn') }}">{{ $user->About }}</textarea>
                                                        @error('about')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="form-button text-center">
                                                        <button type="submit"
                                                                class="form-btn primary-btn">{{ __('Cập nhật') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                    ...
                                    <form class="change-password-form mt-5" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="password" class="form-control" id="CurrentPassword"
                                                           ...
                                                           placeholder="{{ __('Mật khẩu hiện tại') }}" required=""/>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="password" class="form-control" id="NewPassword"
                                                           name="new_password" placeholder="{{ __('Mật khẩu mới') }}"
                                                           required=""/>
                                                    @error('new_password')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="password" class="form-control" id="ConfirmPassword"
                                                           ...
                                                           placeholder="{{ __('Xác nhận mật khẩu') }}" required=""/>
                                            ...
                                            <div>
                                                <div class="form-button text-center">
                                                    <button type="submit"
                                                            class="form-btn primary-btn">{{ __('Lưu thay đổi') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
