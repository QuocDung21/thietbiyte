...
class ProductController extends Controller
{
    ...
    public function physicalProductUpdate($data, $product)
    {
        ...
        $update = $product->update([
            ...
            'fr_Product_Name' => is_null($data['en_product_name']) ? $product->fr_Product_Name : $data['en_product_name'],
            'fr_About' => is_null($data['en_product_name']) ? $product->fr_About : $data['en_product_name'],
            'fr_Description' => is_null($data['en_product_name']) ? $product->fr_Description : $data['en_product_name'],
            'fr_ShippingReturn' => is_null($data['en_product_name']) ? $product->fr_ShippingReturn : $data['en_product_name'],
            'fr_AdditionalInformation' => is_null($data['en_product_name']) ? $product->fr_AdditionalInformation : $data['en_product_name'],
